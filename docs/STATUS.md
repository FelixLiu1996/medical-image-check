...
5. 先完成首篇论文主文 Figure 范围内 31 处声明的精确双区域标注，再生成同一主文闭世界范围的默认负例；Supplement 相关 6 处延后，不阻塞当前试点。
...
- 公众号论文样本链路已验证到聚合声明和主文干净 Figure：37/37 处文字口径已解析，当前主文范围 31 处的双方资产已取得，但精确双区域映射仍为 0/31。Supplement 相关 6 处已延后，不再是当前阻塞项；当前没有把真实公众号正文、标注图片、论文附件或本地清单提交到仓库。
