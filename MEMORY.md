...
- 本地开发版本为 `0.1.0a6`，扫描算法版本为 `generic-image-local-1+western-blot-1+fluorescence-1+pathology-1+excel-advanced-1`。
...
1. 推送 `0.1.0a6`，等待并核验 Windows/Linux CI 和 Windows portable。
